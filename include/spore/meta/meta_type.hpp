...
namespace spore
{
    template <
        std::size_t name_v,
        any_meta_tuple_of<is_meta_base> bases_t,
        any_meta_tuple_of<is_meta_field> fields_t,
        any_meta_tuple_of<is_meta_function> functions_t,
        any_meta_tuple_of<is_meta_constructor> constructors_t,
